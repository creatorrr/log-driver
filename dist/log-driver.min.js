...
"use strict";var _interopRequire=function(e){return e&&e.__esModule?e["default"]:e},_applyConstructor=function(e,r){var t=Object.create(e.prototype),n=e.apply(t,r);return null==n||"object"!=typeof n&&"function"!=typeof n?t:n},_createClass=function(){function e(e,r){for(var t in r){var n=r[t];n.configurable=!0,n.value&&(n.writable=!0)}Object.defineProperties(e,r)}return function(r,t,n){return t&&e(r.prototype,t),n&&e(r,n),r}}(),_get=function e(r,t,n){var i=Object.getOwnPropertyDescriptor(r,t);if(void 0===i){var o=Object.getPrototypeOf(r);return null===o?void 0:e(o,t,n)}if("value"in i&&i.writable)return i.value;var u=i.get;return void 0===u?void 0:u.call(n)},_inherits=function(e,r){if("function"!=typeof r&&null!==r)throw new TypeError("Super expression must either be null or a function, not "+typeof r);e.prototype=Object.create(r&&r.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),r&&(e.__proto__=r)},_classCallCheck=function(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")},stream=_interopRequire(require("stream")),uuid=_interopRequire(require("uuid")),invert=_interopRequire(require("lodash/object/invert")),mapValues=_interopRequire(require("lodash/object/mapValues")),cloneDeep=_interopRequire(require("lodash/lang/cloneDeep")),Driver=_interopRequire(require("./driver")),_utils=require("./utils"),assign=_utils.assign,isBrowser=_utils.isBrowser,isNode=_utils.isNode,store=_utils.store,CLIENT_LOG_ID="__LOG_DRIVER_CLIENT_ID__",CLIENT_ID_CACHE=void 0,Logger=function(e){function r(){var e=this,t=void 0===arguments[0]?"log":arguments[0],n=void 0===arguments[1]?{}:arguments[1];_classCallCheck(this,r),n.objectMode=!0,_get(Object.getPrototypeOf(r.prototype),"constructor",this).call(this,n);var i=r.levelMap,o=uuid.v4(),u=isBrowser()?store?store.get(CLIENT_LOG_ID)||store.set(CLIENT_LOG_ID,o):CLIENT_ID_CACHE||function(e){return CLIENT_ID_CACHE=e}(o):null;assign(this,{name:t,clientId:u}),this.setLevel(r.TRACE);for(var a in i)!function(r){e[r.toLowerCase()]=function(){for(var t,n=arguments.length,o=Array(n),u=0;n>u;u++)o[u]=arguments[u];return(t=e).log.apply(t,[i[r]].concat(o))}}(a)}return _inherits(r,e),_createClass(r,{logger:{get:function(){return this}},setLevel:{value:function(e){return this._level=e,this}},getLevel:{value:function(){return this._level}},getCurrentEntry:{value:function(){return cloneDeep(this._currentEntry)}},log:{value:function(e){for(var r=arguments.length,t=Array(r>1?r-1:0),n=1;r>n;n++)t[n-1]=arguments[n];var i=new Date,o=this,u=o.name,a=o.clientId,s={timestamp:i,name:u,clientId:a,level:e,rawLog:t};return this._currentEntry=s,this.write(t),this}},pipe:{value:function(e){var t=function(e,r){var n=r.pipe;r.on("pipe",function(e){assign(r,{logger:e.logger,getCurrentEntry:e.getCurrentEntry.bind(e)})}),r.pipe=function(e){return t(r,e),n.call(r,e)}};return t(this,e),_get(Object.getPrototypeOf(r.prototype),"pipe",this).call(this,e)}}},{levelMap:{get:function(){var e=invert(["TRACE","DEBUG","INFO","WARN","ERROR","SILENT"]);return mapValues(e,function(e){return+e})}},createDriver:{value:function(){for(var e=arguments.length,r=Array(e),t=0;e>t;t++)r[t]=arguments[t];return _applyConstructor(Driver,r)}}}),r}(stream.PassThrough);assign(Logger,Logger.levelMap),module.exports=Logger;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var assign=Object.assign,isNode=function(){return!("undefined"==typeof module||!module.exports)},isBrowser=function(){return!(isNode()||"undefined"==typeof window)},sessionStorage="undefined"!=typeof window&&window.sessionStorage,store=sessionStorage&&{get:function(e){return sessionStorage.getItem(e)},set:function(e,s){return sessionStorage.setItem(e,s)||s}};exports.isNode=isNode,exports.isBrowser=isBrowser,exports.sessionStorage=sessionStorage,exports.store=store,exports.assign=assign;


},{}]},{},[105])


//# sourceMappingURL=log-driver.min.js.map